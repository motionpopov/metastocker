...
- **Dynamic Prompts**: Model-specific prompts, including Adobe Stock category IDs generated by the default GPT-5.6 Luna model.
...
3. **Select your preferred AI model** (`gpt-5.6-luna` is the cost-efficient default for large batches).
